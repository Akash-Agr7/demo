            ...
            <ScrollView bounces={false} style={styles.subcontainer}>
                ...
                <View>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subHeading}>{'Enter your details to continue'}</Text>
                    </View>
                    <View>
                        ...
                        <Text style={styles.alert}>{emailValidError ? emailValidError : null}</Text>
                        ...
                        <View>
                            ...
                            activeOpacity={0.3}
                                onPress={() => {
                                    checkPass() ? setPassValidError(' ') : setPassValidError('Password must match')
                                }}
                            >
